...
const userSchema = new mongoose.Schema({
  ...
  // Custom WhatsApp message template (caretaker can edit)
  // Placeholders: {tenantName} {previousReading} {currentReading} {unitsUsed} {waterCost} {houseNumber}
  messageTemplate: {
    type: String,
  ...
  // Custom WhatsApp message template (caretaker can edit)
  // Available placeholders: {tenantName} {houseNumber} {previousReading}
